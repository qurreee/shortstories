...
<body>
    ...
    <header class="container h-screen max-w-full bg-blue-100 flex justify-center items-center">
        <div class="md:p-10 md:mx-auto container flex gap-10 justify-center items-center">
            ...
            {{-- login form --}}
            <form action="/login" method="POST" class="bg-blue-200 p-10 rounded mx-auto">
                @csrf
                <div class="mb-5">
                ...
                <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">Don't have an account? <a href="#" class="font-medium text-blue-600 hover:underline dark:text-blue-500 text-wrap">Register</a></p>
            </form>
        </div>
    </header>
