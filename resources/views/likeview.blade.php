...
<body class="bg-white dark:bg-gray-900">
    ...
    <main class="mt-20 min-h-screen max-w-full bg-white dark:bg-gray-900 justify-center content-start">
        ...
        <div class="container mx-auto mb-10">
            <h1 class=" text-center mt-10 mb-10 text-4xl sm:text-5xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Liked Stories</h1>
        </div>
