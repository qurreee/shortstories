...
<body class="dark:bg-gray-900 bg-white">
    ...
    <section class="bg-white dark:bg-gray-900 max-w-full h-screen flex justify-center items-center">
        <div class="grid px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12 container">
   ...
   {{-- popular --}}
    <section id="target" class="pt-20 dark:bg-gray-900 ">
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 mx-auto mb-20 container justify-items-strecth">
                ...
                <div class=" bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 flex flex-col">
                    <a href="/story/{{$story['id']}}">
                        ...
                        @endif
                         {{-- <img class="rounded-t-lg hidden sm:block object-scale-down max-h-56 object-center w-full" src="{{URL('storage/photo/picfolder/'.'/'.$story->cover)}}" alt="" /> --}}
                        {{-- Debug statement --}}   
                    </a>
